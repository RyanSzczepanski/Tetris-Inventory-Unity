...
public class InventoryCellDrawSettingsSO : ScriptableObject
{
    ...
    public Color    _cellColor              = new(0.10f, 0.10f, 0.10f, 0.85f);
    public Color    _cellAccentColor        = new(0.15f, 0.15f, 0.15f, 0.85f);

    public Color    _cellOutlineColor       = new(0.30f, 0.30f, 0.30f, 0.75f);
    public Color    _cellOutlineAccentColor = new(0.40f, 0.40f, 0.40f, 0.85f);

    public Color    _outlineColor           = new(0.90f, 0.90f, 0.90f, 0.50f);
    public Color    _outlineAccentColor     = new(0.85f, 0.85f, 0.85f, 0.60f);
}
